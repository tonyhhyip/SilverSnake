...
abstract class DbConnection extends \PDO {
	...
	*/
	...
	public function tablePrefix($table = 'default') {
		$table = isset($this->prefixes[$table]) ? $table : 'default';
	 ...
	 */
	public function getDriverClass($class, $dir = __FILE__) {
		if (empty($this->driverClasses[$class])) {
			$driver = $this->driver();
			$this->driverClasses[$class] = '$class_$driver';
			$_ENV['classloader']->defineClass($this->driverClasses[$class], dirname($dir) . "/$class_$driver.php");
		}

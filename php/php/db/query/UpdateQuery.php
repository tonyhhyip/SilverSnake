...
class UpdateQuery extends Query implements QueryConditionInterface {
	...
	*/
	 ...
	 */
	public function setExists(SelectQueryInterface $select) {
	 ...
	 */
	public function setNotExists(SelectQueryInterface $select) {
	...
	public function getParameter() {
		return $this->condition->getParameter();
	}

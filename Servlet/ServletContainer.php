<?php
if (!defined("ServletContainer")) {
  define("ServletContainer", 1);

  require("Function.php");

  require_once("Servlet/RESTfulRequest.php");
  require_once("Servlet/RESTfulResponse.php");
  require_once("Servlet/HttpServlet.php");

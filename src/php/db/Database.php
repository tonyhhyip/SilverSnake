...
abstract class Database {
	...
	*/
	 ...
	 * @see DatabaseLog
	*/
	public final static function startLog($logging_key, $key = 'default') {
	 ...
	 * @see DatabaseLog
	 */
	public final static function getLog($logging_key, $key = 'default') {
		if (empty(self::$logs[$key])) {
			return NULL;
		}
	 ...
	 */
	public final static function getConnection($target = 'default', $key = NULL) {
		if (!isset($key)) {
	 ...
	 *   otherwise.
	 */
	public final static function isActiveConnection() {
	 ...
	 */
	public final static function setActiveConnection($key = 'default') {
	 ...
	 */
	public final static function parseConnectionInfo() {
		global $databases;
	 ...
	 */
	public final static function getConnectionInfo($key = 'default') {
		if (empty(self::$databaseInfo)) {
			self::parseConnectionInfo();
		}
	 ...
	 */
	public final static function renameConnection($old_key, $new_key) {
		if (empty(self::$databaseInfo)) {
			self::parseConnectionInfo();
		}
	 ...
	 *   TRUE in case of success, FALSE otherwise.
	 */
	public final static function removeConnection($key) {
	 ...
	 */
	protected final static function openConnection($key, $target) {
		if (empty(self::$databaseInfo)) {
			self::parseConnectionInfo();
		}
